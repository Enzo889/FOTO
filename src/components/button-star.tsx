...
const ButtonShootingStarBorder: React.FC<ButtonShootingStarBorderProps> = ({
  ...
  return (
    <button className="group relative grid overflow-hidden rounded-full px-4 py-1 shadow-[0_1000px_0_0_hsl(0_0%_10%)_inset] dark:shadow-[0_1000px_0_0_hsl(0_0%_20%)_inset] transition-colors duration-200 -z-10">
      <span>
